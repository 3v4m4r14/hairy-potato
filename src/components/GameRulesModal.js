      ...
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        ...
        <div className="rules-section">
          ...
          <div className="payout-grid">
            ...
            <div>5 Hedgehogs</div><div>75x</div>
        ...
        <div className="rules-section">
          ...
          <div className="payout-grid">
            ...
            <div>5 Sport Bikes in a row</div><div>8x</div>
            <div>5 Trophies in a row</div><div>5x</div>
            <div>4 in a row</div><div>2-10x</div>
            <div>3 special symbols</div><div>2-5x</div>
            <div>4 in column</div><div>2-12x</div>
          </div>
        </div>
        ...
        <div className="rules-section">
          ...
          <ul>
            <li>Return to Player (RTP): 87.92%</li>
